# Tiling Cache Plan Update

- [x] Review the proposed tiling cache plan against the current cache and extraction flow.
- [x] Decide the authoritative cache-hit semantics for run-local `skip_existing` outputs.
