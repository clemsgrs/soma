...
- soma skips slide2vec 5.4.0 entirely — no interim pin, no throwaway migration of the doomed `iter_regions_dense` call site. soma is knowingly broken against 5.4.0 and aligns once against 5.5.0.
