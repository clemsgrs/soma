...
def derive_preprocessing_for_aggregator(
    ...
    if preprocessing.requested_region_size_px is not None and resolved_requested_region_size_px is not None:
        if int(preprocessing.requested_region_size_px) != int(resolved_requested_region_size_px):
            raise ValueError(
                "HIPT derives requested_region_size_px from aggregator params; "
                f"got requested_region_size_px={preprocessing.requested_region_size_px} and "
                f"resolved_region_size_px={resolved_requested_region_size_px}."
            )
